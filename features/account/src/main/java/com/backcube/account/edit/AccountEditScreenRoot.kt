...
fun AccountEditScreenRoot(
    ...
    Scaffold(
        topBar = {
            CustomTopBar(
                title = stringResource(com.backcube.ui.R.string.account_title),
        ...
        if (item != null) {
            Column {
                CustomTextInput(
                    ...
                    leadingText = stringResource(id = com.backcube.ui.R.string.account_name),
                    textStyle = TextStyle(
                ...
                CustomTextInput(
                    ...
                    leadingText = stringResource(id = com.backcube.ui.R.string.account_balance),
                ...
                CustomListItem(
                    title = stringResource(com.backcube.ui.R.string.account_currency),
                    isSmallItem = true,
                    showLeading = false,
